...
import { LogIn, Home, User, Menu, Webcam } from "lucide-react"; // Import icons from lucide-react
        ...
        <header className="sticky top-4 inset-x-0 z-50 w-full">
            <nav className="relative mx-auto max-w-[66rem] w-full backdrop-blur-md bg-white/60 border border-gray-200 dark:border-neutral-700 rounded-[26px] py-2 px-5 flex flex-wrap md:justify-start md:flex-nowrap">
                ...
                <div className="flex items-center justify-between w-full">
                    <Link className="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white font-inter" to="#" aria-label="Brand">Brand</Link>
                ...
                >
                    <div className="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                        <div className="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                            <Link className="p-2 flex items-center text-sm text-blue-600 font-medium hover:text-blue-500 focus:outline-none focus:text-blue-500 dark:text-blue-500 dark:focus:text-blue-500 font-inter" to="#" aria-current="page">
                                <Home className="mr-2" />
                                Landing
                            </Link>

                            <Link className="p-2 flex items-center text-sm text-gray-800 font-medium hover:text-gray-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500 font-inter" to="#">
                                <User className="mr-2" />
                                Account
                            </Link>
                            ...
                            <div className="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5 md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-gray-300 before:-translate-y-1/2 dark:before:bg-neutral-700">
                                <Link className="p-2 w-full flex items-center text-sm text-gray-800 hover:text-gray-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500 font-inter" to="#">
